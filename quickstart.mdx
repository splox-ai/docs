...
the agent writes it into its harness as a [program](/concepts/program).
[Reach you outside a chat](/ask/reach-you) and [On a schedule](/ask/on-a-schedule)
show what that looks like.

**Ask it to change.** "Give yourself a tool for X." "Be shorter." "Use a cheaper
...
what changed. [Ask](/ask/overview) is the section for that, and
[Versions](/inside/versions) is how you go back if you do not like it.
