...
<CardGroup cols={3}>
  <Card title="Agent Chat" icon="messages" href="https://chat.splox.io">
    **chat.splox.io**
    ...
    Browse agents and start chatting — no setup required
  </Card>
  <Card title="Desktop App" icon="desktop" href="https://splox.io/download">
    **Windows, macOS, Linux**
    
    Native agent chat app with voice support
  </Card>
...
<Info>
**Using the Desktop App?** The desktop app connects to [chat.splox.io](https://chat.splox.io) — browse agents and start chatting with voice or text.
</Info>
...
<Tabs>
  <Tab title="Agent Chat (chat.splox.io)">
    **Chat with agents in your browser**
    ...
    1. Go to [chat.splox.io](https://chat.splox.io)
    2. Browse the **agent marketplace** and select an agent
  ...
  <Tab title="Desktop App">
    **Native agent chat on your OS**
    ...
    4. Browse agents and start chatting
    
    **Best for:** Voice interaction, always-available agent chat
  </Tab>

  <Tab title="Workflow Builder (app.splox.io)">
    **Chat with your own workflows**
    
    1. Open your workflow on [app.splox.io](https://app.splox.io)
    2. Click the **Chat icon** (speech bubble) in the toolbar
    3. Select your **Start node** from the dropdown
    4. This opens a chat on [chat.splox.io](https://chat.splox.io) connected to your workflow
  </Tab>
  ...
  <Tab title="API">
    ...
    **Best for:** Production automations, external integrations. See [API docs](/api-reference/introduction).
  </Tab>
</Tabs>
