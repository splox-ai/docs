...
<Frame>
  <img 
    src="https://splox-app.s3.amazonaws.com/019c39de-1efb-73ce-bbf7-1d7da8c84f49.png" 
...
<Steps>
  ...
  <Step title="Testing & Execution">
    ...
    **Chat Actions:**
    ...
    <Frame>
      <img 
        src="https://splox-app.s3.amazonaws.com/019c39df-08cd-73ce-be5c-39626bc7eed8.png" 
    ...
    <Steps>
      <Step title="Select Entry Node">
        Choose where to begin execution from the available entry nodes
      </Step>
...
<Steps>
  <Step title="Agent Receives Input">
    The Agent node receives input from its parent (entry node payload, previous node output, or variable mappings) and appends it as a user message to its context memory.
  </Step>
...
<Tabs>
  ...
  <Tab title="LLM Configuration">
    - **Provider & Model:** Choose from Anthropic, OpenAI, Gemini, OpenRouter, and more
    - **System Prompt:** Jinja2 template with variable mapping support
  ...
  <Tab title="Iteration Control">
    - **Max Iterations:** 1–50 (default: 50). Limits how many tool-call rounds the agent can perform.
