...
version](/build/versions) covers the whole loop.
...
being a question anybody has to answer. [Programs](/build/programs) shows the
shape.
...
[Sub-agents](/build/subagents) explains why the split exists.
