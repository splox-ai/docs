...
<div className="block dark:hidden">
  <img
    src="https://splox-app.s3.amazonaws.com/019a0b7b-6d45-70ea-9bdd-1200071f5480_conditional-edges-light.png"
    alt="Conditional Edges - Switch Node with IF, ELIF, and ELSE branches to different Template Nodes"
...
<div className="hidden dark:block">
  <img
    src="https://splox-app.s3.amazonaws.com/019a0b7b-6d44-70ea-98f4-d2d2ae5fd5f7_conditional-edges-dark.png"
    alt="Conditional Edges - Switch Node with IF, ELIF, and ELSE branches to different Template Nodes"
    style={{ borderRadius: '0.5rem' }}
  />
</div>
