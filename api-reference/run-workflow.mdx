...
1. **A chat session** — Create one via [Create Chat](/api-reference/create-chat)
2. **A workflow version ID** — The ID of the workflow version to execute
3. **A start node ID** — The ID of the Start node to begin execution at
