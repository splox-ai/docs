...
<img src="TODO: add screenshot" alt="Configuring the Tool node with an MCP server and tool selection" style={{ borderRadius: '12px' }} />
...
- **Add memory** — open the Agent node config and enable the **Memory** option for multi-turn conversations
