...
<img src="https://splox-app.s3.amazonaws.com/019c7552-96c7-744c-a48f-b8a2237e8eab.png" alt="Creating a new workflow in Splox" style={{ borderRadius: '12px' }} />
...
<img src="https://splox-app.s3.amazonaws.com/019c7553-5b92-744c-b378-0fdf3fdbe7b1.png" alt="Adding a Start node to the workflow canvas" style={{ borderRadius: '12px' }} />
...
Click on any node to open its configuration panel on the right. For the Agent node, you can customize:

| Setting | Description |
|---|---|
| **System Prompt** | Instructions that define your agent's behavior and persona |
| **Model** | Switch between LLM providers and models (e.g. Claude, GPT-4o, Gemini) |
| **Memory** | Tune context window limits, trim strategy, summarization, and more |
| **Streaming** | Enable/disable real-time streaming responses |
| **Max Iterations** | Limit how many tool calls the agent can make per turn |
| **Tool Choice** | Control whether the agent must use a tool, can choose, or is restricted |

<img src="TODO: add screenshot" alt="Agent node configuration panel" style={{ borderRadius: '12px' }} />
